...
public class TransactionController {
    ...
    ResponseEntity<Resource> transcribe(@RequestParam("file") MultipartFile file) {
        ...
        List<String> allowedAudioExtensions = List.of(
        ...
        System.out.println(">>> 1 - Arquivo recebido: " + file.getOriginalFilename());

        var userMessage = transcriptionModel.transcribe(file.getResource());
        System.out.println(">>> 2 - Transcrição: " + userMessage);
        ...
        System.out.println(">>> 3 - Resposta da IA: " + result);

        byte[] audio = textToSpeechModel.call(result);
        System.out.println(">>> 4 - Áudio gerado: " + audio.length + " bytes");
